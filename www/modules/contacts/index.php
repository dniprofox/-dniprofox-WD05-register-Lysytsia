...
//загружаем контакты в массив $contacts
...
if ( empty($errors)) {
		...
		if ( isset($_FILES["file"]["name"]) && $_FILES["file"]["tmp_name"] != "" ) {
			...
			if($fileSize > 4194304) {
				$errors[] = ['title' => 'Загружаемый файл имеет размер более 4mb' ];
				...
				$errors[] = ['title' => 'Ошибка загрузки' ];
			}

			$postImgFolderLocation = ROOT . 'usercontent/upload_files/';

			// Перемещаем загруженный файл в upload_files
