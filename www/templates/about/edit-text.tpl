...
<div class="container">
	<div class="row">
		<div class="col-xl-10 offset-1">
			...
			<form class="form mb-100 pb-20 pt-35" action="edit-text" method="post"
			 enctype="multipart/form-data">
				...
				<div class="comment-row">Изображение jpg или png, размером больше чем 100х100 пикселей, и весом до 2Мб.
				</div>
